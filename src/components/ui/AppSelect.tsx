    ...
    >
      ...
      <Select.Portal>
        <Select.Content
          position="popper"
          sideOffset={6}
          className="z-[200] min-w-[var(--radix-select-trigger-width)] overflow-hidden rounded-lg border border-slate-200 bg-white p-1.5 text-sm text-slate-700 shadow-lg"
        >
